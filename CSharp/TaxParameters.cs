...
namespace BusinessLogic.TaxSystem.Calculator
{
    ...
    {
        protected TaxParameters(TaxParametersBase @base)
        {
            if (@base == null)
            {
    ...
    {
        protected UsnTaxParameters(Rate usnRate, TaxParametersBase baseParams)
            : base(baseParams)
        {
            UsnRate = usnRate;
        }
    ...
    {
        protected OsnTaxParameters(Rate ndsRate, TaxParametersBase baseParams)
            : base(baseParams)
        {
            NdsRate = ndsRate;
        }
    ...
    {
        protected IndividualUsnTaxParameters(
